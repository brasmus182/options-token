...
import {Exercise, BOathExerciseParams} from "../src/exercise/BOathExercise.sol";
...
contract OptionsTokenTest is Test {
    ...
    function test_exerciseHappyPath(uint256 amount, address recipient) public {
        ...
        BOathExerciseParams memory params = BOathExerciseParams({paymentTokenAmount: expectedPaymentAmount, minBPTOut: 0});
...
//copy whole thing and alter it
    //import, variable declarations, change setup etc, to match BoathExercise.sol, then figure out how to test it

//testing valid happy path
    //Make sure it redeems correct amount with varying amounts
